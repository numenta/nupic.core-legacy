...
def getExtensionFileNames(platform):
  ...
  files = [os.path.join(PY_BINDINGS, "staging", "nupic", "bindings", name)
...
def generateExtensions():
  ...
  try:
    ...
    pyExtensionsDir = os.path.join(PY_BINDINGS, "staging", "nupic", "bindings")
    os.mkdir(scriptsDir)
    os.chdir(scriptsDir)
...
if __name__ == "__main__":
  ...
  destDir = os.path.relpath(os.path.join("staging", "nupic", "proto"))
  ...
  setup(
    ...
    package_dir = {"": "staging"},
    packages=find_packages("staging"),
