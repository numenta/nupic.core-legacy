...
- To use Include What You Use during compilation, pass '-DNUPIC-IWYU=ON'.  This requires that IWYU is installed and findable by CMake, and a minimum CMake version of 3.3.  IWYU can be installed on OS X using https://github.com/jasonmp85/homebrew-iwyu.
