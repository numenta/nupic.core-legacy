...
> **Note**: The `-j3` option-some-conflicted-edits-for-testing dummy-specifies '3' as the maximum number of parallel jobs/threads that Make will use during the build in order to gain speed. However, you can increase this number depending your CPU.
