...
set(YAMLCPPLIB_INSTALL_PREFIX ${EP_BASE}/Install/YamlCppLibStaticLib)
set(YAMLCPPLIB_INSTALL_INC_DIR ${YAMLCPPLIB_INSTALL_PREFIX}/include)
set(YAMLCPPLIB_INSTALL_LIB_DIR ${YAMLCPPLIB_INSTALL_PREFIX}/lib)

# Export directory of installed z lib headers to parent
set(LIB_STATIC_YAML_CPP_INC_DIR ${YAMLCPPLIB_INSTALL_INC_DIR} PARENT_SCOPE)
