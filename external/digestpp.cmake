...
#
if(EXISTS "${REPOSITORY_DIR}/build/ThirdParty/share/digestpp.tar.gz")
    set(URL "${REPOSITORY_DIR}/build/ThirdParty/share/digestpp.tar.gz")
else()
    set(URL https://github.com/kerukuro/digestpp/archive/master.tar.gz)
endif()
