...
if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  set(CAPNP_DEFINITIONS -DCAPNP_LITE=1 -DEXTERNAL_CAPNP=1 -DBUILD_TOOLS=OFF )
else()
...
if(${capnp_cxx_flags} MATCHES "-fuse-linker-plugin" AND UNIX)
  # NOTE Capnproto link fails with segfault on Travis and Ubuntu when using
  # linker plugin as part of -flto optimization together with -O2
  # Reference https://github.com/sandstorm-io/capnproto/issues/300

  # Turn off -fuse-linker-plugin to work around this issue
  set(capnp_cxx_flags "${capnp_cxx_flags} -fno-use-linker-plugin")
endif()
