...
set(MSVC_SHARED_RT OFF CACHE BOOL "Use MT rather than MD" FORCE)
add_subdirectory(${yaml-cpp_SOURCE_DIR} ${yaml-cpp_BINARY_DIR})

set(yaml-cpp_INCLUDE_DIRS ${yaml-cpp_SOURCE_DIR}/include) 
if (MSVC)
  set(yaml-cpp_LIBRARIES   "${yaml-cpp_BINARY_DIR}$<$<CONFIG:Release>:/Release/libyaml-cppmt.lib>$<$<CONFIG:Debug>:/Debug/libyaml-cppmtd.lib>") 
else()
