...
//  {
//    Test("nearlyEqual Reals 1", true, nearlyEqual(Real(0.0),
//    Real(0.0000000001))); Test("nearlyEqual Reals 2", true, nearlyEqual(0.0,
//    0.0)); Test("nearlyEqual Reals 3", false, nearlyEqual(0.0, 1.0));
...
//    Test("nearlyEqual Reals 7", true, nearlyEqual(Real(2.0),
//    Real(2.000000001))); Test("nearlyEqual Reals 8", true,
//    nearlyEqual(Real(2.0), Real(1.999999999))); Test("nearlyEqual Reals 9",
//    true, nearlyEqual(Real(-2.0), Real(-2.000000001))); Test("nearlyEqual
//    Reals 10", true, nearlyEqual(Real(-2.0), Real(-1.999999999)));
//  }
//
//  //--------------------------------------------------------------------------------
...
//
//    {
//      Test("nearlyEqualVector, empty vectors", true, nearlyEqualVector(v1,
//      v2));
//
//      v2.push_back(1);
//      Test("nearlyEqualVector, different sizes", false, nearlyEqualVector(v1,
//      v2));
//
//      v1.push_back(1);
...
//        v2.push_back(v);
//      }
//      Test("nearlyEqualVector, 2049 elements 1", true, nearlyEqualVector(v1,
//      v2));
//
//      v2[512] += 1.0;
//      Test("nearlyEqualVector, 2049 elements 2", false, nearlyEqualVector(v1,
//      v2));
//
//      v1.clear(); v2.clear();
...
//        Test("Normalize vector<Real>, empty", true, nearlyEqualVector(empty1,
//        empty1));
//      }
//
//      {
...
//        Test("Normalize vector<Real> 12", true, nearlyEqualVector(v1,
//        answer));
//      }
//
//      {
//        v1[0] = Real(1.0); v1[1] = Real(1.0); v1[2] = Real(1.0);
//        answer[0] = Real(1.0/3.0); answer[1] = Real(1.0/3.0); answer[2] =
//        Real(1.0/3.0); normalize(v1.begin(), v1.end()); Real s = sum(v1);
//        Test("Normalize vector<Real> 21", true, nearlyEqual(s, Real(1.0)));
//        Test("Normalize vector<Real> 22", true, nearlyEqualVector(v1,
//        answer));
//      }
//
//      {
//        v1[0] = Real(0.5); v1[1] = Real(0.5); v1[2] = Real(0.5);
//        answer[0] = Real(0.5/1.5); answer[1] = Real(0.5/1.5); answer[2] =
//        Real(0.5/1.5); normalize(v1.begin(), v1.end()); Real s = sum(v1);
//        Test("Normalize vector<Real> 31", true, nearlyEqual(s, Real(1.0)));
//        Test("Normalize vector<Real> 32", true, nearlyEqualVector(v1,
//        answer));
//      }
//
//      {
//        v1[0] = Real(1.0); v1[1] = Real(0.5); v1[2] = Real(1.0);
//        answer[0] = Real(1.0/2.5); answer[1] = Real(0.5/2.5); answer[2] =
//        Real(1.0/2.5); normalize(v1.begin(), v1.end()); Real s = sum(v1);
//        Test("Normalize vector<Real> 41", true, nearlyEqual(s, Real(1.0)));
//        Test("Normalize vector<Real> 42", true, nearlyEqualVector(v1,
//        answer));
//      }
//
//      { // Test normalizing to non-1.0
//        v1[0] = Real(1.0); v1[1] = Real(0.5); v1[2] = Real(1.0);
//        answer[0] = Real(3.0/2.5); answer[1] = Real(1.5/2.5); answer[2] =
//        Real(3.0/2.5); normalize(v1.begin(), v1.end(), 1.0, 3.0); Real s =
//        sum(v1); Test("Normalize vector<Real> 51", true, nearlyEqual(s,
//        Real(3.0))); Test("Normalize vector<Real> 52", true,
//        nearlyEqualVector(v1, answer));
//      }
//    }
//
//    { // normalize
...
//        normalize(empty1.begin(), empty1.end());
//        Test("Normalize VectorType, empty", true, nearlyEqualVector(empty1,
//        empty1));
//      }
//
//      {
...
//
//        Real s = accumulate(v.begin() + k2, v.begin() + boundaries[k1],
//        (Real)0); Test("Maths winnerTakesAll2 2", s, (Real) 1);
//
//        k2 = boundaries[k1];
//      }
//
...
//      n = 1000;
//      double lb = -1, ub = 1, t_lb = -2, t_ub = 2, t_step = (t_ub -
//      t_lb)/(10*n);
//
//      QSI<double, Exp<double> > q_e1(lb, ub, n, Exp<double>());
//      Test("qsi f 1", q_e1.max_error(t_lb, t_ub, t_step).second <= 1e-8,
//      true);
//
//      QSI<double, Exp2<double> > q_e2(lb, ub, n, Exp2<double>());
//      Test("qsi f 2", q_e2.max_error(t_lb, t_ub, t_step).second <= 1e-7,
//      true);
//    }
//
//    {
//      n = 2000;
//      Real lb = -1, ub = 1, t_lb = -2, t_ub = 2, t_step = (t_ub -
//      t_lb)/(10*n);
//
//      QSI<Real, Exp<Real> > q_e1(lb, ub, n, Exp<Real>());
//      Test("qsi f 3", q_e1.max_error(t_lb, t_ub, t_step).second <= 1e-3,
//      true);
//
//      QSI<Real, Exp2<Real> > q_e2(lb, ub, n, Exp2<Real>());
//      Test("qsi f 4", q_e2.max_error(t_lb, t_ub, t_step).second <= 1e-3,
//      true);
//    }
//
...
//      t_lb)/(10*n);
//
//      QSI<double, Exp<double> > q_e1(lb, ub, n, Exp<double>(1, 2),
//      Exp<double>(2, 2)); Test("qsi f ff 1", q_e1.max_error(t_lb, t_ub,
//      t_step).second <= 1e-7, true);
//    }
//
//    {
//      n = 2000;
//      Real lb = -1, ub = 1, t_lb = -2, t_ub = 2, t_step = (t_ub -
//      t_lb)/(10*n); QSI<Real, Exp<Real> > q_e2(lb, ub, n, Exp<Real>(1, 2),
//      Exp<Real>(2, 2)); Test("qsi f ff 2", q_e2.max_error(t_lb, t_ub,
//      t_step).second <= 1e-5, true);
//    }
//
//    { // Vector to vector
//      n = 1000;
//      double v, lb = -1, ub = 1, t_lb = -2, t_ub = 2, t_step = (t_ub -
//      t_lb)/(n); vector<double> x(n), y(n), yref(n);
//
//      v = lb;
//
...
//      }
//
//      QSI<double, Exp<double> > q_e1(lb, ub, n, Exp<double>(1,1),
//      Exp<double>(1,1)); q_e1(x.begin(), x.end(), y.begin()); Test("qsi vector
//      1", nearlyEqualRange(y.begin(), y.end(), yref.begin()), true);
//    }
//
//    { // Vector to itself
//      n = 1000;
//      double v, lb = -1, ub = 1, t_lb = -2, t_ub = 2, t_step = (t_ub -
//      t_lb)/(n); vector<double> vv(n), yref(n);
//
//      v = lb;
//
//      for (UInt i = 0; i < n; ++i, v += t_step) {
...
//
//      QSI<double, Exp<double> > q_e1(lb, ub, n, Exp<double>(1,1),
//      Exp<double>(1,1)); q_e1(vv.begin(), vv.end()); Test("qsi vector 1",
//      nearlyEqualRange(vv.begin(), vv.end(), yref.begin()), true);
//    }
//    */
//  }
//
