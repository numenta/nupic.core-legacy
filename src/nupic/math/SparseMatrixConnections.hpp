...
public:
   ...
   */
  void computeActivity(const UInt32 *activeInputs_begin,
   ...
   */
  void adjustSynapses(const UInt32 *segments_begin, const UInt32 *segments_end,
   ...
   * Additive constant for each active synapse's permanence
   */
  void adjustActiveSynapses(const UInt32 *segments_begin,
   ...
   * Additive constant for each inactive synapse's permanence
   */
  void adjustInactiveSynapses(const UInt32 *segments_begin,
                              const UInt32 *segments_end,
                              const UInt32 *activeInputs_begin,
                              const UInt32 *activeInputs_end,
                              Real32 permanenceDelta);
   ...
   */
  void growSynapses(const UInt32 *segments_begin, const UInt32 *segments_end,
   ...
   */
  void growSynapsesToSample(const UInt32 *segments_begin,
                            const UInt32 *segments_end,
                            const UInt32 *inputs_begin,
                            const UInt32 *inputs_end, Int32 sampleSize,
  ...
  void growSynapsesToSample(const UInt32 *segments_begin,
                            ...
                            const Int32 *sampleSizes_begin,
                            const Int32 *sampleSizes_end,
                            Real32 initialPermanence, nupic::Random &rng);
   ...
   * The segments to modify
   */
  void clipPermanences(const UInt32 *segments_begin,
                       const UInt32 *segments_end);
   ...
   */
  void mapSegmentsToSynapseCounts(const UInt32 *segments_begin,
                                  const UInt32 *segments_end,
