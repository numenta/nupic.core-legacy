 ...
 * TODO: this file is currently superceded by built-in python set(), keeping as
 * a reference, and we should test which is faster for intersection workload,
...
//
// Test from Python:
// Mac PowerBook 2.8 GHz Core 2 Duo, 10.6.3, -O3 -DNDEBUG, gcc 4.2.1 (Apple
// 5659) m = 50000, n1 = 40, n2 = 10000: 0.00274658203125
// 0.00162267684937 1.69262415516 m = 50000, n1 = 80, n2 = 10000:
// 0.00458002090454 0.00179862976074 2.54639448568 m = 50000, n1 = 200, n2 =
// 10000: 0.0124213695526 0.00241708755493 5.13898204774 m = 50000, n1 = 500, n2
// = 10000: 0.0339875221252 0.00330281257629 10.2904785967 m = 50000, n1 = 1000,
// n2 = 10000: 0.0573344230652 0.00443959236145 12.9143440202 m = 50000, n1 =
// 2500, n2 = 10000: 0.155576944351 0.00838160514832 18.5617124164 m = 50000, n1
// = 5000, n2 = 10000: 0.256726026535 0.0143656730652 17.8707969595
//--------------------------------------------------------------------------------
template <typename T = size_t, typename T_byte = unsigned char> class Set {
private:
...
public:
  ...
  inline T n_bytes() const { (T)return s.size(); }
