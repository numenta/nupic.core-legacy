 ...
 */
Real32 computeRawAnomalyScore(const std::vector<UInt>& active, const std::vector<UInt>& predicted);
...
class Anomaly
{
  public:
    ...
    */
    Real32 compute(const std::vector<UInt>& active, const std::vector<UInt>& predicted, 
