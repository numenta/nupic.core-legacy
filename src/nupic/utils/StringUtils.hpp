...
*/
bool toBool(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
UInt32 toUInt32(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
Int32 toInt32(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
UInt64 toUInt64(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
Real32 toReal32(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
Real64 toReal64(const std::string& s, bool throwOnError = false, bool * fail = nullptr);
size_t toSizeT(const std::string& s, bool throwOnError = false, bool * fail = nullptr);

bool startsWith(const std::string &s, const std::string &prefix);
bool endsWith(const std::string &s, const std::string &ending);
std::string trim(const std::string &s);

inline bool is_base64(unsigned char ch) {
 ...
 * @retval    string
 */
std::string fromInt(long long i);
...
* @retval      encoded string
*/
std::string base64Encode(const void *buf, Size inLen);
...
*
* @param encoded_str a string to decode
* @retval    decoded string
*/

std::string base64Decode(const std::string &encoded_str);
...
*/
std::string hexEncode(const void *buf, Size inLen);
 ...
 * @retval     void
 */
void toIntList(const std::string& s, std::vector<Int>& list, bool allowAll=false,
                      bool asRanges=false);
 ...
 */
bool toIntListNoThrow(const std::string& s, std::vector<Int>& list,
